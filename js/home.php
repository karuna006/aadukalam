...
.dropdown2 [data-toggle="dropdown"] {
  ...
  color: white;
  background: #c1bfbf;
  -moz-box-shadow: 0 1px 0 #c1bfbf inset, 0 -1px 0 #c1bfbf inset;
  -webkit-box-shadow: 0 1px 0 #c1bfbf inset, 0 -1px 0 #c1bfbf inset;
  box-shadow: 0 1px 0 #c1bfbf inset, 0 -1px 0 #c1bfbf inset;
...
@-webkit-keyframes hideAnimation {
  ...
  <div class="add-products">  
	...
	<div class="container">
		<ul>
    <li2 class="dropdown2">
      <a href="#" data-toggle="dropdown">Red Revolution<i class="icon-arrow2"></i></a>
    ...
    <li2 class="dropdown2">
      <a href="#" data-toggle="dropdown">Green Revolution<i class="icon-arrow2"></i></a>
      <ul class="dropdown-menu2">
        <li2><a href="#">Home</a></li2>
        <li2><a href="#">About Us</a></li2>
      </ul>
    ...
    <li2 class="dropdown2">
      <a href="#" data-toggle="dropdown">White Revolution<i class="icon-arrow2"></i></a>
      <ul class="dropdown-menu2">
        <li2><a href="#">Home</a></li2>
        <li2><a href="#">About Us</a></li2>
      </ul>
